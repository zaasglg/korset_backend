...
class StoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'media' => 'required_without:content|file|mimes:jpeg,png,jpg,gif,mp4,mov,avi|max:20480', // 20MB max
            'expires_in_hours' => 'nullable|integer|min:1|max:48', // Default is 24 hours, max 48 hours
        ]);
